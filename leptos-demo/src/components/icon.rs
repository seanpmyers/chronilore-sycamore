...
pub const FERRIS_SVG_HTML: SvgIcon = r#"
...
pub const BOT_SVG_HTML: SvgIcon = r#"
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24" stroke="currentColor" fill="none">
	...
	<line x1="128" y1="56" x2="128" y2="16" fill="none" stroke="currentColor" stroke-linecap="round"
		stroke-linejoin="round" stroke-width="16" />
	<circle cx="84" cy="108" r="12" stroke="currentColor" />
	<circle cx="172" cy="108" r="12" stroke="currentColor" />
</svg>
"#;
